...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('characters', '0003_alter_marshal_character_user_ranger'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character_class', models.CharField(choices=[('Marshal', 'Marshal'), ('Rager', 'Ranger')], default='Marshal')),
                ...
                ('character_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='marshal_character', to=settings.AUTH_USER_MODEL)),
            ],
        ),
